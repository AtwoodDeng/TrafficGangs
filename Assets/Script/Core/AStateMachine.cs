...
public class AStateMachine<StateType,EventType> 
	...
	private Dictionary<StateType,EventHandler> eventHandlerDict = new Dictionary<StateType, EventHandler> ();
	...
	/// <summary>
	/// Blinds the state event handler.
	/// </summary>
	/// <param name="state">State.</param>
	/// <param name="handler">Handler.</param>
	public void BlindStateEventHandler( StateType state , EventHandler handler )
	{
		if ( !eventHandlerDict.ContainsKey(state ))
			eventHandlerDict.Add (state, handler);	
	}
	...
	/// </summary>
	/// <param name="type">Type.</param>
	public void OnEvent(EventType type , object arg )
	{
		...
		if (eventHandlerDict.ContainsKey (State)) {
			eventHandlerDict [State].Invoke (arg);
		}
	}
}
